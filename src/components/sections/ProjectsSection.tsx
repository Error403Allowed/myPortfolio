...
const projects = [
  ...
  {
    title: "Quantus",
    desc: "This is a machine learning model that I have built from scratch using pytorch. I have built a neural network that calculates various stock indicators against any stock in the US (which the user can choose by inputting a stock ticker). It is built entirely using python and pytorch and is run in CLI (command-line interface).",
    tags: ["Python", "Pytorch", "Machine Learning", "Neural Network", "CLI"],
    link: "Must be viewed in CLI, refer to my github repository for more information!",
    github: "https://github.com/Error403Allowed/Quantus",
    cover: "/Quantus.png",
  },
  {
    title: "PDF BLOB Extractor",
    desc: "This is a small lightweight utility tool I built in python that can retrieve PDF documents stored in an Oracle Database as BLOB (Binary Large Object) data. The utility is built entirely in python and using some SQL.",
